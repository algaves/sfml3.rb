...
* Unit tests (minitest) for Clock, Transformable, Circle, RenderState, VideoMode — headless, deterministic; avoid Circle#scale and Transform.inverse due to known bugs.
...
### Changed
* Project renamed to sfml3.rb; planned migration from SFML 2 to SFML 3.
