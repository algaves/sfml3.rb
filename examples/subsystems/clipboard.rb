...
# includes non-ASCII text through `Clipboard.string=` and `unicode_string=`;
# V reads it back with `Clipboard.string` and renders it. The two entry points
