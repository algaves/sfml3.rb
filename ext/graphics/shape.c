...
static VALUE CustomShape_update(VALUE self) {
    sfShape_update(Get_Shape_Struct(self));
    return self;
}
...
static VALUE CustomShape_get_fill_color(VALUE self) {
    return color_to_rb(sfShape_getFillColor(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_set_fill_color(VALUE self, VALUE rb_color) {
    sfShape_setFillColor(Get_Shape_Struct(self), color_from_rb(rb_color));
    return rb_color;
}
...
static VALUE CustomShape_get_outline_color(VALUE self) {
    return color_to_rb(sfShape_getOutlineColor(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_set_outline_color(VALUE self, VALUE rb_color) {
    sfShape_setOutlineColor(Get_Shape_Struct(self), color_from_rb(rb_color));
    return rb_color;
}
...
static VALUE CustomShape_get_outline_thickness(VALUE self) {
    return DBL2NUM(sfShape_getOutlineThickness(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_set_outline_thickness(VALUE self, VALUE rb_thickness) {
    sfShape_setOutlineThickness(Get_Shape_Struct(self), NUM2DBL(rb_thickness));
    return rb_thickness;
}
...
static VALUE CustomShape_get_texture_rect(VALUE self) {
    return int_rect_to_rb(sfShape_getTextureRect(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_set_texture_rect(VALUE self, VALUE rb_rect) {
    sfShape_setTextureRect(Get_Shape_Struct(self), int_rect_from_rb(rb_rect));
    return rb_rect;
}
...
static VALUE CustomShape_get_geometric_center(VALUE self) {
    return vec2f_to_rb(sfShape_getGeometricCenter(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_get_local_bounds(VALUE self) {
    return rect_to_rb(sfShape_getLocalBounds(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_get_global_bounds(VALUE self) {
    return rect_to_rb(sfShape_getGlobalBounds(Get_Shape_Struct(self)));
}
...
static VALUE CustomShape_draw(VALUE self, VALUE rb_target, VALUE rb_state) {
    ...
    TARGET_DRAW(view, sfRenderWindow_drawShape, sfRenderTexture_drawShape, Get_Shape_Struct(self),
 ...
 * Includes Transformable and Drawable, and is the base of CircleShape,
...
void Init_Shape(VALUE rb_mSFML) {
    ...
    rb_include_module(rb_cCustomShape, Get_Module_Transformable());
