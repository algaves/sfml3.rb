...
RSpec.describe SF::Audio::SoundBuffer do
  it 'builds a buffer from samples' do
    buffer = SF::Audio::SoundBuffer.from_samples([0, 100, -100, 0], 1, 44_100)
  ...
  it 'builds a buffer from a packed string' do
    ...
    buffer = SF::Audio::SoundBuffer.from_samples(packed, 1, 22_050)
  ...
  it 'copies and saves a buffer' do
    buffer = SF::Audio::SoundBuffer.from_samples([1, 2, 3, 4], 1, 8000)
    copy = buffer.copy
    ...
    begin
      ...
      reloaded = SF::Audio::SoundBuffer.from_file(path)
  ...
  it 'loads a buffer from a stream' do
    ...
    begin
      SF::Audio::SoundBuffer.from_samples([1, 2, 3, 4, 5, 6], 1, 8000).save_to_file(path)
      buffer = SF::Audio::SoundBuffer.from_stream(File.open(path, 'rb'))
